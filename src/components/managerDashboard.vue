<!-- <template>
    <div class="container topWidth d-flex justify-content-between">
      <div class="card">
        Planing
        <div class="chartSize d-flex justify-content-center">
  ...
  export default {
    ...
    mounted() {
      const ctx = this.$refs.myChartCanvas; // Reference to the canvas element
            ...
            <div class="col-xl-6 col-lg-6 widthOfcard">
                <div class="card l-bg-cherry">
                    <div class="card-statistic-3 p-2">
                        ...
                        <div class="mb-4">
                            <h5 class="card-title mb-0">Planing</h5>
                        </div>
...
<dashBoard2></dashBoard2>
   ...
   <script>
     import Chart from 'chart.js/auto';
     import dashBoard2 from './managerDash2.vue'
