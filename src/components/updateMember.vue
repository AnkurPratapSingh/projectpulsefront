                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4" style="color:#28a745">Update Member</p>
                                ...
                                <form class="mx-1 mx-md-4">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-2">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="password" id="form3Example4c" class="form-control" v-model="password" placeholder="Password " disabled/>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-2">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <input type="password" id="form3Example4cd" class="form-control" v-model="repassword" placeholder="Confirm Password"  disabled/>
                                    ...
                                    <div class="d-flex justify-content-center mx-4 mb-2 mb-lg-4">
                                        <button type="button" @click="Update" class="btn  btn-success btn-lg" :disabled="isSubmitDisabled">Update</button>
                                    </div>
...
export default {
    ...
    methods: {
        async Update() {
            if (this.isChecked !== true) {
                ...
                const result = await axios.patch("http://localhost:5000/user/updateUser/" + this.$route.params.id,{
                    username: this.name,
                        email: this.email,
    ...
    async mounted() {
        ...
        const response = await axios.get('http://localhost:5000/user/getUserByIdParam/'+this.$route.params.id, {
            headers: {
